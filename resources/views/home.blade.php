        ...
        <div class="grid grid-cols-3 gap-5 justify-items-center overflow-hidden px-7 py-8">
            ...
            @else
                @foreach ($petanis as $petani)
                    @if ($petani->petani)
                        <div class="max-w-sm p-6 bg-[#1A5319] border border-gray-200 rounded-lg shadow flex flex-col">
                            <a href="#">
                            ...
                            <a href="#"
                                class="inline-flex mt-auto items-center justify-between px-3 py-2 text-sm font-medium text-center text-white bg-[#123524] rounded-lg hover:text-[#123524] hover:bg-[#EFE3C2] focus:ring-4 focus:outline-none focus:ring-blue-300">
                                Read more
